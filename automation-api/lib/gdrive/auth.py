...
def authorize(
    ...
    return AuthorizedClients(gc=gc, drive_service=drive_service, sheets_service=sheets_service)
...
def authorized_service_account_credentials(
    ...
    service_account_credentials = base64.b64decode(b64_encoded_service_account_credentials).decode("utf-8")
